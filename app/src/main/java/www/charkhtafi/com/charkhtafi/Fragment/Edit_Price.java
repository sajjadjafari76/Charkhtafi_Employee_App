...
import www.charkhtafi.com.charkhtafi.Login;
    ...
    private List<EditPriceModel> getData() {
        ...
        for (int i = 0; i < 4; i++) {
            if (i == 0) {
                ...
                model.setId("1432");
                model.setImage("https://onehdwallpaper.com/wp-content/uploads/2016/05/Full-HD-Banana-Fruit-HD-Photos.jpg");
                model.setName("موز");
                model.setPrice("4000");
                ...
                EditPriceModel model = new EditPriceModel();
                model.setId("365481");
                model.setImage("http://www.golsamsepahan.com/wp-content/uploads/2017/02/potato_png2391.png");
                ...
                EditPriceModel model = new EditPriceModel();
                model.setId("785584");
                model.setImage("https://www.parsegard.com/sites/default/files/content_types/food_nutrition/9571/main_image/pineapple.jpg");
                ...
                EditPriceModel model = new EditPriceModel();
                model.setId("454");
                model.setImage("http://salamatezanan.ir/wp-content/uploads/peach-950x950.png");
                model.setName("هلو");
                model.setPrice("4000");
                model.setType("کیلویی");
                data.add(model);
