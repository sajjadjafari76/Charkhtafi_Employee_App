...
import www.charkhtafi.com.charkhtafi.Adapter.OrderFruitAdapter;
    ...
    private List<OrderModel> getdata() {
        ...
        for (int i = 0; i < 15; i++) {
            if (i == 0) {
                ...
                model1.setImage("http://www.golsamsepahan.com/wp-content/uploads/2017/02/potato_png2391.png");
                model11.add(model1);
                ...
                model2.setImage("https://www.parsegard.com/sites/default/files/content_types/food_nutrition/9571/main_image/pineapple.jpg");
                model22.add(model2);
                ...
                model3.setImage("https://www.parsegard.com/sites/default/files/content_types/food_nutrition/9571/main_image/pineapple.jpg");
                model22.add(model3);
                ...
                model3.setImage("http://salamatezanan.ir/wp-content/uploads/peach-950x950.png");
                model33.add(model3);
